...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" style={{ backgroundColor: '#e3e1e2' }}>
      ...
      <div className="relative z-10 w-full pt-20 mr-14 lg:mr-0">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="w-full lg:max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
            <span className="text-sm uppercase mb-6 block animate-blur-in opacity-0 tracking-[0.3em] font-semibold" style={{ animationDelay: '0.2s', animationFillMode: 'forwards', color: '#c9a84c' }}>
              Kenya's #1 LED Lighting Store
            </span>
            <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[1.1] mb-6 text-balance text-white drop-shadow-lg">
              <span className="block animate-blur-in opacity-0 font-semibold" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>Light Up Your</span>
              <span className="block animate-blur-in opacity-0 font-semibold xl:text-9xl text-7xl" style={{ animationDelay: '0.6s', animationFillMode: 'forwards', color: '#c9a84c' }}>Ride.</span>
            </h2>
            <p className="text-lg leading-relaxed mb-10 max-w-md mx-auto lg:mx-0 animate-blur-in opacity-0" style={{ animationDelay: '0.8s', animationFillMode: 'forwards', color: 'rgba(232,232,224,0.85)' }}>
              Premium LED headlights, fog lights, and interior lighting for every vehicle. Brighter roads, safer drives.
            </p>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2" style={{ color: '#c9a84c' }}>
